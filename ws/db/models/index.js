...
db[model.name] = model;
model = require(path.join(__dirname, './coin'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './orderbook'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './pair'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './order'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './trade'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './balance'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './deposit'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './withdrawal'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './transaction'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './userCoin'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
